//
//  OccupationTestTableViewController.m
//  Plexx
//
...
@interface OccupationTestTableViewController ()

@end

@implementation OccupationTestTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    PFTableViewCell *cell = (PFTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"occupationCell"];
    
    // Configure the cell
        [cell.textLabel setFont:UbuntuSmall];
