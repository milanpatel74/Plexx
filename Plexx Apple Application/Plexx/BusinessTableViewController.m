...
- (id)initWithCoder:(NSCoder *)aCoder {
    ...
    if (self) {
        ...
        self.className = @"JobsBusiness";
        self.parseClassName = @"JobsBusiness";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    static NSString *CellIdentifier = @"BusinessJobCell";
    
    BusinessJobCell *jobCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    //UIImage *companyImage = [PictureLoader requestJobPicture:object[@"category"]];
    //UIImage *companyImage = [PictureLoader requestJobPicture:@"Business & Information Systems"];

    UIImage *companyImage = [PictureLoader requestJobPicture:@"Business & Information Systems" optionalIndex:indexPath.row];
    ...
    NSLog(@"BUSINESS %i, %i", [objectTable count], indexPath.row);
