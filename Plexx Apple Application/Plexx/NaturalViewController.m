...
#import "NaturalViewController.h"

//#import "ArtsTableViewController.h"

#import "NaturalJobCell.h"
...
@interface NaturalViewController ()

@end

@implementation NaturalViewController
...
- (id)initWithCoder:(NSCoder *)aCoder {
    ...
    if (self) {
        ...
        self.className = @"JobsNatAndAgriServ";
        self.parseClassName = @"JobsNatAndAgriServ";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    static NSString *CellIdentifier = @"NaturalJobCell";
    
    NaturalJobCell *jobCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    //////////////////
...
//    +(UIImage *)requestJobPicture:(NSString *)category optionalIndex:(NSInteger) opIndex{
    ...
    UIImage *companyImage = [PictureLoader requestJobPicture:@"Natural & Agricultural Services" optionalIndex:indexPath.row];
...
/*
    ...
    */
    ...
    jobCell.parseObject = object;
    NSLog(@"NATURAL %i, %i", [objectTable count], indexPath.row);
