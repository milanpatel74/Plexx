...
- (id)initWithCoder:(NSCoder *)aCoder {
    ...
    if (self) {
        ...
        self.className = @"JobsHumAndPubServ";
        self.parseClassName = @"JobsHumAndPubServ";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    static NSString *CellIdentifier = @"HumanJobCell";
    
    HumanJobCell *jobCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    //UIImage *companyImage = [PictureLoader requestJobPicture:object[@"category"]];
//    UIImage *companyImage = [PictureLoader requestJobPicture:@"Human & Public Services"];

    UIImage *companyImage = [PictureLoader requestJobPicture:@"Human & Public Services" optionalIndex:indexPath.row];
    ...
    NSLog(@"HUMAN %i, %i", [objectTable count], indexPath.row);
