...
@interface ArtsTableViewController ()

@end

@implementation ArtsTableViewController
...
- (id)initWithCoder:(NSCoder *)aCoder {
    ...
    if (self) {
        ...
        self.className = @"JobsArtsHum";
        self.parseClassName = @"JobsArtsHum";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    static NSString *CellIdentifier = @"ArtsJobCell";
    
    ArtsJobCell *jobCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    //UIImage *companyImage = [PictureLoader requestJobPicture:object[@"category"]];
//    UIImage *companyImage = [PictureLoader requestJobPicture:@"Arts & Humanities"];

    UIImage *companyImage = [PictureLoader requestJobPicture:@"Arts & Humanities" optionalIndex:indexPath.row];
    ...
    NSLog(@"ARTS %i, %i", [objectTable count], indexPath.row);
