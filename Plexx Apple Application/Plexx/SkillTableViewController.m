...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    static NSString *CellIdentifier = @"SkillTableCell";
    
    SkillTableCell *skillCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    /*
...
//    NSLog(@"IN LOAD");
    ...
    [skillCell.buttonAAttributes setTitle:@"Test Yourself" forState:normal];
    [[skillCell.buttonAAttributes titleLabel] setFont:UbuntuSmall];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PFObject *parseObjectForCellSelected = [objectTable objectAtIndex:([indexPath row]-1)];
