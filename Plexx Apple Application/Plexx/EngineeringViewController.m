...
@interface EngineeringViewController ()

@end

@implementation EngineeringViewController
...
- (id)initWithCoder:(NSCoder *)aCoder {
    ...
    if (self) {
        ...
        self.className = @"JobsEngineer";
        self.parseClassName = @"JobsEngineer";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    static NSString *CellIdentifier = @"EngineeringJobCell";
    
    EngineeringJobCell *jobCell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    //UIImage *companyImage = [PictureLoader requestJobPicture:object[@"category"]];
//    UIImage *companyImage = [PictureLoader requestJobPicture:@"Engineering & Technology"];
    UIImage *companyImage = [PictureLoader requestJobPicture:@"Engineering & Technology" optionalIndex:indexPath.row];
 ...
 //   NSString *jobSalary = [NSString stringWithFormat:@"$%@", object[@"salary"]];
   // NSString *timeAndSalary = [NSString stringWithFormat:@"%@ ~ %@", object[@"employmentType"], jobSalary];
    ...
    NSLog(@"ENGINEERING %i, %i", [objectTable count], indexPath.row);
